...
def schedule():
    ...
    places = [[37.7012, -122.5343], [37.8443, -122.3864], [37.7465, -122.3801]]
    ...
    for i in range(len(places)-1):
        ...
        result, status_code = get_route_from_inrix(start_wp[0], start_wp[1], end_wp[0], end_wp[1], token)
...
def quickpath1():
    ...
    places = [[37.4034, -121.9313], [37.3495, -121.9368], [37.6223, -122.3801]]
    works = [[37.770581, -122.442550], [37.765297,-122.442527]]

    # app.logger.debug(f'Type of start_lat: {type(wp11).__name__}')
    
    # result, status_code = get_route_from_inrix(works[0][0], works[0][1], works[1][0], works[1][1], token1) #works
    result, status_code = get_route_from_inrix(places[0][0], places[0][1], places[1][0], places[1][1], token1)
    # result, status_code = get_route_from_inrix("37.770581", "-122.442550", "37.765297", "-122.442527", token1) #works
